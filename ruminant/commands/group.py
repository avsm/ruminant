...
def generate_group_prompt(group: str, repositories: List[str], year: int, week: int) -> dict:
    ...
    prompt_lines.extend([
        ...
        "2. **Activity**: Combined overview of completed work and ongoing initiatives across repositories, minimizing repetition with new features section (MUST use bullet points)",
        "3. **Cross-Repository Work**: Highlight any connected work, dependencies, or collaborations between repositories (MUST use bullet points)",
        "4. **Notable Discussions**: Important discussions from any repository (MUST use bullet points)",
        "5. **Emerging Trends**: Patterns observed across the group (MUST use bullet points)",
        "",
        ...
        '  "activity": "Markdown content combining completed work and ongoing initiatives, minimizing repetition with new features - set to null if no activity exists",',
